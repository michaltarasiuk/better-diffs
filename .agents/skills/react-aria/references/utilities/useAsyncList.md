...
`useAsyncList` extends on [useListData](useListData.md), adding support for async loading, pagination, sorting, and filtering.
...
<FunctionAPI
  function={docs.exports.useAsyncList}
  links={docs.links}
/>
...
You can use the state returned by `useAsyncList` to render a [collection component](collections.md).
...
See the docs for [useListData](useListData.md) for more details.
