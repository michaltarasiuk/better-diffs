...
<ModalTrigger label="Open dialog">
  {(close) => (
    <Dialog title="Enter your name">
      <p>
        This dialog is built with <code>useModalOverlay</code> and{' '}
        <code>useDialog</code>.
      </p>
      <Button
        onPress={close}
